...
@EnableZuulProxy
public class MsSampleApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(MsSampleApplicationApp.class);

    private final Environment env;

    public MsSampleApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes msSampleApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MsSampleApplicationApp.class);
